...
public class ExperimentLimitDaoTest extends BaseTest {
    ...
    @Test
    public void updateExperimentLimit() {
        ExperimentLimit experimentLimit = new ExperimentLimit(0, 1009, 10013);
        int result = experimentLimitDao.updateExperimentLimit(experimentLimit);
        System.out.println(result);
    }
